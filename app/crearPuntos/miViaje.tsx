...
export default function CrearViaje() {
  ...
  const handleCreateViaje = async () => {
    ...
    const nuevoViaje = {
      ...
      direccion: destino === "Universidad de la Sabana" ? origen : destino,
      fecha: fecha.trim(),
      ...
      <View style={styles.originDestContainer}>
        <View style={styles.inputWrapper}>
          ...
          onPress={(data, details = null) => {
            ...
            // Puedes guardar: details.geometry.location.lat & lng si quieres coordenadas
          }}
          query={{
            key: 'TU_API_KEY',
            language: 'es',
            components: 'country:co', // opcional: filtra por país
          }}
          styles={{
